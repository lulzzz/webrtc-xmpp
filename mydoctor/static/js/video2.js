(function() {
    ...
    function initStreams() {
        ...
        var successCallback = function(stream) {
            ...
            $("#me").addClass("active");
            usersNode.html("<div class=\"text\">Connected...</div>");
            reconnect();
        };

        var errorCallback = function(error) {
            usersNode.html("<div class=\"text\">Pls, allow access to your mic / cam</div>");
    ...
    function addVideo(evt, userId) {
        var item = $("<div class=\"video\"><video></video><i class=\"sound\" title=\"Sound\"></i></div>");
    ...
    function removeUser(userId) {
        ...
        if (pc) {
            ...
            pc.close();
            video.remove();
            if (usersNode.children().length == 0) usersNode.html("<div class=\"text\">Awaiting for users...</div>");
        }
    };
    ...
    function reconnect() {
        ...
        sock.onopen = function () {
            ...
            usersNode.html("<div class=\"text\">Awaiting for users..</div>");
        };
